...
");
    ...
    public static List<char> leftBrackets = CAGConsts.ToList('(', '{', '[');
    public static List<char> rightBrackets = CAGConsts.ToList(')', '}', ']');
    public static List<string> leftBracketsS = CAGConsts.ToList("(", "{", "[");
    public static List<string> rightBracketsS = CAGConsts.ToList(")", "}", "]");
    ...
    public static readonly List<string> numberPoints = new List<string> { ",", "." };
}
